...
> **Note:** To view the TypeScript SDK source code, visit the [`@anthropic-ai/claude-code` page on NPM](https://www.npmjs.com/package/@anthropic-ai/claude-code?activeTab=code).
...
```
    ...
    * `@anthropic-ai/claude-code` from NPM
    ...
    > **Note:** To view the Python SDK source code, see the [`claude-code-sdk`](https://github.com/anthropics/claude-code-sdk-python) repo.

    > **Tip:** For interactive development, use [IPython](https://ipython.org/): `pip install ipython`
...
```
    ...
    > **Note:** The Python examples on this page use `asyncio`, but you can also use `anyio`.
...
```python
    ...
    async def use_permission_prompt():
        ...
        async with ClaudeSDKClient(
            options=ClaudeCodeOptions(
                permission_prompt_tool="mcp__security__approval_prompt",
                mcp_servers=mcp_servers,
